...
export const STATIC_I18N_KEYS = [
  ...
  'If you are a subscriber, please confirm that this model is available in your subscription group.',
  'Low',
  'Medium',
  'Motion Imitation',
  'Music Generation',
  ...
  'Smart',
  'Standard 1K',
  'Subscription balance can only be used with the corresponding subscription group. Please confirm that this model is available there.',
  'This model is temporarily unavailable. Please try again later or switch to another model.',
  'Ultra 4K',
  'Video Duration',
  'Video Generation',
  'Video Parameters',
  'Video generation failed',
  'Video task submitted, but no video URL was returned.',
  'Voice Generation',
  ...
  'Expired at',
  'Cancelled at',
  'Ali SDK / DashScope Native Pricing',
  'Configure pricing used only by Ali SDK / DashScope Native channels',
  'Native model prices',
  'These prices are isolated to ChannelType 10001 and are not used by ordinary NewAPI model pricing.',
  'Add model',
  'Save DashScope Native pricing',
  'Billing unit',
  'Base price',
  'Conditional prices',
  ...
  'Select DashScope Native channel',
  'Fetch DashScope Native prices',
  'No DashScope Native channels found',
  'No DashScope Native price differences found',
  'DashScope Native prices fetched successfully',
  'Please select a DashScope Native channel',
  'These prices are isolated to Ali SDK / DashScope Native channels and are not used by ordinary NewAPI model pricing.',
  'Price configuration',
  'Input price',
  'Output price',
  'Cache read price',
