  ...
  return (
    ...
    >
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className='grid h-10 w-full grid-cols-2 items-stretch gap-1 rounded-xl bg-white/5 p-1'>
          <TabsTrigger
            value='bindings'
            className='h-full gap-2 rounded-lg px-3 py-0 leading-none data-active:bg-white/10 data-active:text-white'
          >
